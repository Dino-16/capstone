            ...
            <div class="card border-0 shadow-lg rounded-4" style="min-width: 450px; max-width: 550px;">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Please verify you're not a robot to continue browsing our career
                            opportunities.</p>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" onclick="verifyHomeRecaptcha()" class="btn btn-primary btn-lg"
        ...
        <div @class('container')>
            <div @class('row')>
                <div @class('col-lg-12 col-12')>
                    <h1 @class('text-white fw-bold')>BUILD YOUR CAREER IN <span @class('text-warning')>TRAVEL &
                            TOURISM</span> - GROW, EXPLORE, AND MAKE AN IMPACT</h1>
                    <p @class('text-white w-75')>Join a workforce that travels the world, deliver unforgettable
                        experiences and builds real career opportunities</p>
                    <a href="https://careers-hr1.jetlougetravels-ph.com/" @class('btn btn-dark btn-lg fs-3')>View
                        Careers</a>
                </div>
            </div>
        </div>
        <img src="{{ asset('images/home-1.png') }}" @class('hero-image position-absolute bottom-0 end-0')
            alt="Hero Image">
    </section>
                ...
                <div @class('col-lg-6 col-md-12 ps-lg-5')>
                    ...
                    <ul @class('list-unstyled')>
                        <li @class('d-flex align-items-start mb-3')>
                            ...
                            <p @class('mb-0')>Clear career paths for tour guides, agents, drivers, and operations staff
                            </p>
                        </li>
                        <li @class('d-flex align-items-start mb-3')>
        ...
        <div @class('container')>
            <div @class('row text-center')>
                <div @class('col-lg-4 col-md-12 mb-4 mb-lg-0')>
                    <img src="{{ asset('images/home-3.png') }}" alt="Maria Del Valle" @class('rounded-circle mb-3')
                        width="150" height="150">
                    <h4 @class('fw-bold')>Maria Del Valle</h4>
                    <p @class('text-sm px-4')>Started as a tour guide; now a senior operations supervisor managing 30+
                        tours.</p>
                    <div @class('stars')>
                ...
                <div @class('col-lg-4 col-md-12 mb-4 mb-lg-0')>
                    <img src="{{ asset('images/home-4.png') }}" alt="Clifford Hiller" @class('rounded-circle mb-3')
                        width="150" height="150">
                ...
                <div @class('col-lg-4 col-md-12')>
                    <img src="{{ asset('images/home-5.png') }}" alt="Lia Hidalgo" @class('rounded-circle mb-3')
                        width="150" height="150">
                    <h4 @class('fw-bold')>Lia Hidalgo</h4>
                    <p @class('text-sm px-4')>Joined as customer support; now works internationally with partner
                        agencies.</p>
                    <div @class('stars')>
                        <i @class('fas fa-star text-warning')></i>
                        <i @class('fas fa-star text-warning')></i>
            ...
            <div @class('row g-4 py-5')>
                    ...
                    <div @class('row g-3')>
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-6.png') }}" alt="Competitive salary" @class('me-3')
                        ...
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-7.png') }}" alt="Training" @class('me-3')
                                    style='width: 50px; height: 50px; object-fit: contain;'>
                                <p @class('mb-0') style="font-size: 32px;">Free or subsidized training & certifications
                                </p>
                            </div>
                        </div>
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-8.png') }}" alt="Flexible schedules" @class('me-3')
                                    style='width: 50px; height: 50px; object-fit: contain;'>
                                <p @class('mb-0') style="font-size: 32px;">Flexible schedules (seasonal, full-time, or
                                    part-time)</p>
                            </div>
                        </div>
                    </div>
                ...
                <div @class('col-lg-6')>
                    <div @class('row g-3')>
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-9.png') }}" alt="Travel perks" @class('me-3')
                                    style='width: 50px; height: 50px; object-fit: contain;'>
                                <p @class('mb-0') style="font-size: 32px;">Travel perks and destination-based
                                    assignments</p>
                            </div>
                        </div>
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-10.png') }}" alt="Career growth" @class('me-3')
                                    style='width: 50px; height: 50px; object-fit: contain;'>
                        ...
                        <div @class('col-12 text-start')>
                            <div @class('d-flex align-items-center mb-3')>
                                <img src="{{ asset('images/home-11.png') }}" alt="Working environment" @class('me-3')
                                    style='width: 50px; height: 50px; object-fit: contain;'>
                                <p @class('mb-0') style="font-size: 32px;">Inclusive, diverse, and safe working
                                    environment</p>
                            </div>
                        </div>
                    </div>
